...
Browser (Chrome) examples â€” canonical quick-checks

Open the URL directly in the browser address bar to view JSON â€” no extra JavaScript or tools required. Modern browsers (Chrome, Firefox) format JSON responses automatically for easy reading.
